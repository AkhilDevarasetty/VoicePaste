...
export function LiveStatusPanel() {
  return (
    <section className="soft-card overflow-hidden rounded-[30px]">
      <div className="grid gap-4 p-5 lg:grid-cols-[1.45fr_0.75fr] lg:p-6">
        <div className="relative overflow-hidden rounded-[24px] bg-[linear-gradient(135deg,rgba(88,110,124,0.95),rgba(109,132,146,0.9)_38%,rgba(229,220,201,0.92)_100%)] p-6 text-white">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-3 max-w-lg text-sm leading-6 text-white/82 lg:text-base">
              Keep capturing from the menu bar while this dashboard becomes your clean review surface for transcripts, retries, and workflow actions.
            </p>
        ...
        <div className="surface-muted rounded-[24px] p-5 lg:p-6">
          ...
          <div className="mt-6 grid gap-3">
            <div className="rounded-2xl bg-white/78 px-4 py-3">
